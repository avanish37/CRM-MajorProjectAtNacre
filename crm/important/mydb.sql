...
-- Mon Jan 22 16:38:55 2018
-- Model: New Model    Version: 1.0
-- MySQL Workbench Forward Engineering
-- Created By Nikhil & Abhishek
...
-- -----------------------------------------------------
-- Table `mydb`.`pg_details`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`pg_details` ;

CREATE TABLE IF NOT EXISTS `mydb`.`pg_details` (
  `pg_details_id` INT NOT NULL AUTO_INCREMENT,
  `pg_branch_branch_id` INT NOT NULL,
  `pg_college_college_id` INT NOT NULL,
  `pg_year_year_id` INT NOT NULL,
  `pg_per` FLOAT NULL,
  PRIMARY KEY (`pg_details_id`),
  INDEX `fk_pg_details_branch1_idx` (`pg_branch_branch_id` ASC),
  INDEX `fk_pg_details_college1_idx` (`pg_college_college_id` ASC),
  INDEX `fk_pg_details_year1_idx` (`pg_year_year_id` ASC),
  CONSTRAINT `fk_pg_details_branch1`
    FOREIGN KEY (`pg_branch_branch_id`)
    REFERENCES `mydb`.`branch` (`branch_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_pg_details_college1`
    FOREIGN KEY (`pg_college_college_id`)
    REFERENCES `mydb`.`college` (`college_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_pg_details_year1`
    FOREIGN KEY (`pg_year_year_id`)
...
CREATE TABLE IF NOT EXISTS `mydb`.`acdemic_details` (
  ...
  `pg_details_pg_details_id` INT NULL,
  ...
  INDEX `fk_acdemic_details_pg_details1_idx` (`pg_details_pg_details_id` ASC),
  ...
  CONSTRAINT `fk_acdemic_details_branch1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_acdemic_details_pg_details1`
    FOREIGN KEY (`pg_details_pg_details_id`)
    REFERENCES `mydb`.`pg_details` (`pg_details_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`recrutiment_info_batch_realation`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`recrutiment_info_batch_realation` ;

CREATE TABLE IF NOT EXISTS `mydb`.`recrutiment_info_batch_realation` (
  `recrutiment_info_batch_realation_id` INT NOT NULL AUTO_INCREMENT,
  `recruitment_info_recruitment_info_id` INT NOT NULL,
  `batch_details_batch_details_id` INT NOT NULL,
  PRIMARY KEY (`recrutiment_info_batch_realation_id`),
  INDEX `fk_recrutiment_info_batch_realation_recruitment_info1_idx` (`recruitment_info_recruitment_info_id` ASC),
  INDEX `fk_recrutiment_info_batch_realation_batch_details1_idx` (`batch_details_batch_details_id` ASC),
  CONSTRAINT `fk_recrutiment_info_batch_realation_recruitment_info1`
    FOREIGN KEY (`recruitment_info_recruitment_info_id`)
    REFERENCES `mydb`.`recruitment_info` (`recruitment_info_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_recrutiment_info_batch_realation_batch_details1`
    FOREIGN KEY (`batch_details_batch_details_id`)
    REFERENCES `mydb`.`batch_details` (`batch_details_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
