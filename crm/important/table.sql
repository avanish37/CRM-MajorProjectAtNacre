...
CREATE TABLE IF NOT EXISTS `mydb`.`address` (
  ...
  UNIQUE INDEX `street_UNIQUE` (`street` ASC),
...
-- -----------------------------------------------------
-- Table `mydb`.`graduation_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`graduation_type` ;

CREATE TABLE IF NOT EXISTS `mydb`.`graduation_type` (
  `graduation_type_id` INT NOT NULL AUTO_INCREMENT,
  `gradution_type_name` VARCHAR(45) NULL,
  PRIMARY KEY (`graduation_type_id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`type_of_degree` (
  ...
  `graduation_type_graduation_type_id` INT NOT NULL,
  PRIMARY KEY (`type_of_degree_id`, `graduation_type_graduation_type_id`),
  INDEX `fk_type_of_degree_graduation_type1_idx` (`graduation_type_graduation_type_id` ASC),
  CONSTRAINT `fk_type_of_degree_graduation_type1`
    FOREIGN KEY (`graduation_type_graduation_type_id`)
    REFERENCES `mydb`.`graduation_type` (`graduation_type_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`acdemic_details` (
  ...
  `tenth_school_name` VARCHAR(45) NULL,
  `tenth_board` VARCHAR(45) NULL,
  `tenth_yop` INT NULL,
  `tenth_per` FLOAT NULL,
  `tenth_medium` VARCHAR(45) NULL,
  `twelth_board` VARCHAR(45) NULL,
  `twelth_college` VARCHAR(45) NULL,
  `twelth_yop` INT NULL,
  `twelth_pre` FLOAT NULL,
  `twelth_sub_twelth_sub_id` INT NOT NULL,
  `graduation_college` VARCHAR(45) NULL,
  `graduation_university` VARCHAR(45) NULL,
  `graduation_yop` INT NULL,
  `graduation_per` FLOAT NULL,
  `graduation_branch_branch_id` INT NOT NULL,
  `pg_college` VARCHAR(45) NULL,
  `pg_university` VARCHAR(45) NULL,
  `pg_yop` INT NULL,
  `pg_per` FLOAT NULL,
  `branch_branch_id` INT NOT NULL,
  PRIMARY KEY (`academic_details_id`, `twelth_sub_twelth_sub_id`, `graduation_branch_branch_id`, `branch_branch_id`),
  ...
  INDEX `fk_acdemic_details_branch2_idx` (`branch_branch_id` ASC),
  UNIQUE INDEX `tenth_board_UNIQUE` (`tenth_board` ASC),
...
CREATE TABLE IF NOT EXISTS `mydb`.`trainee_request` (
  ...
  `trainee_request_status_trainee_request_status_id` INT NOT NULL,
  `trainee_request_status_status_id` INT NOT NULL,
  PRIMARY KEY (`trainee_request_id`, `traniee_details_trainee_details_id`, `trainee_request_status_trainee_request_status_id`, `trainee_request_status_status_id`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`trainee_feedback` (
  ...
  `person_details_person_id` INT NOT NULL,
  `feedback_desc` VARCHAR(1000) NULL,
  PRIMARY KEY (`trainee_feedback_id`, `person_details_person_id`),
