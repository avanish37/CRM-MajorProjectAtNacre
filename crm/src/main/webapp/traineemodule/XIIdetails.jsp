...
<div class="panel panel-default" style="width: 75%" >
	...
	<div class="modal fade" id="edit" tabindex="-1" role="dialog"
        ...
        <td><b>XII Board</b></td>
        <td>
        	 <input list="boards"   name=fname onkeyup="validateBoard()"  class="form-control" placeholder="XII Board">
        ...
        <tr>
        <td><b>Medium </b></td>
        <td><input list="medium" name="medium" onkeypress="validateMedium()" class="form-control" placeholder="Medium">
  	 ...
  	 <tr>
        <td><b>Subject </b></td>
        <td><input list="subject" name="subject" onkeypress="validateSubject()" class="form-control" placeholder="Subject">
  				<span id="subjecterrfn" style="color: red"></span>
  				<datalist id="subject">
    				<option value="">
    				<option value="">
    				<option value="">
